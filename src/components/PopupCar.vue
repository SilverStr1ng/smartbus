<template>
  <div class="box">
    ...
    <div class="box-wrap">
      ...
      <div>
        <div class="area">
          <div class="area-title fontColor">{{ carInfo.key_name }}公交车</div>
        </div>
        <div class="content textColor">
          <div class="data-li">
            <div>单程公里数：</div>
            <div>
              <span>{{ carInfo.length }}</span>
            </div>
          </div>
          <div class="data-li">
            <div>首末班车时间：</div>
            <div>
              <span> {{ carInfo.start_time }}~{{ carInfo.end_time }} </span>
            </div>
          </div>
          <div class="data-li">
            <div>单程最高票价：</div>
            <div>
              <span> {{ carInfo.total_price }} 元 </span>
            </div>
          </div>
          <div class="data-li">
            <div>车内人数：</div>
            <div>
              <span class="num"> {{ carInfo.peopleNum }} 人 </span>
            </div>
          </div>
        </div>
      </div>
